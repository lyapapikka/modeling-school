  ...
  return (
    <>
      ...
      <Content>
        ...
        <Link href="/new">
          <a className="w-full bg-neutral-900 rounded-2xl py-5 px-4 flex my-2 max-sm:active:bg-neutral-800 sm:hover:bg-neutral-800">
            ...
            {groups.map((group) =>
              group.map((g) => (
                <Link href={`/group/${g.id}?from=groups`} key={g.id}>
                  <a className="bg-neutral-900 rounded-2xl py-3 px-4 flex gap-4 items-centermax-sm:active:bg-neutral-800 sm:hover:bg-neutral-800">
