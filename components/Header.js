  ...
  return (
    <div className="flex justify-between items-center my-2">
      ...
      <div className="sm:hidden flex fixed justify-around bottom-0 left-0 right-0 w-full bg-neutral-800">
        <button className="w-full flex justify-center sm:hover:bg-neutral-70 rounded-full py-4">
          <HomeIcon className="w-6" />
        </button>
        <button className="w-full flex justify-center sm:hover:bg-neutral-700 rounded-full py-4">
          <BookmarkIcon className="w-6" />
        </button>
        <button className="w-full flex justify-center sm:hover:bg-neutral-700 rounded-full py-4">
          <PlusIcon className="w-6" />
